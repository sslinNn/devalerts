...
def isolated(tmp_path, monkeypatch):
    ...
    sent = []
    monkeypatch.setattr(devalerts, "_send_telegram_message", lambda token, chat_id, text: sent.append(text))
    original_excepthook = sys.excepthook
    original_threading_excepthook = threading.excepthook
    yield sent
    sys.excepthook = original_excepthook
    threading.excepthook = original_threading_excepthook
    devalerts._state["prev_excepthook"] = None
    devalerts._state["prev_threading_excepthook"] = None
